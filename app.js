...
var bathProduct = new Product('img/bathroom.jpg', 'iPad while you iPoo', 'Bathroom iPad Multitool');
var petSweeperProduct = new Product('img/pet-sweep.jpg', 'Put your pets to work as they run around your house with snap on sweepers.', 'Pet Sweeper');
var pizzaScizzorsProduct = new Product('img/scissors.jpg', 'Cut your pizza and plate it in half the time!', 'Pizza Scissors');
var tauntaunProduct = new Product('img/tauntaun.jpg', 'Always wanted to survive the cold perils of Hoth? Now you can!', 'Tauntaun Sleeper');
